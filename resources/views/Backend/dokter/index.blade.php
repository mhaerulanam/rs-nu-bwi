...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                @include('Backend.dokter.add')
                <div class="card-body">
                    @include('Backend.dokter.table')
                </div>
            </div>
        </div>
    </div>
    ...
    @if ($message = Session::get('error-category'))
        <div class="alert alert-danger alert-dismissible" role="alert">
            <strong>{{ $message }}</strong>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                @include('Backend.jabatan_dokter.add')
                <div class="card-body">
                    @include('Backend.jabatan_dokter.table')
                </div>
            </div>
        </div>
    </div>
