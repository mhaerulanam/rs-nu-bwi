                ...
                <div class="card-body">
                    <form action="{{ route('fasilitas.update', $fasilitas->id) }}" method="POST"
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col mb-3">
                                    <label for="nameExLarge" class="form-label">Nama Fasilitas</label>
                                    <input type="text" id="nameExLarge" class="form-control" name="name_fasilitas"
                                        placeholder="Masukkan Nama Fasilitas"
                                        value="{{ isset($fasilitas->name) ? $fasilitas->name : '' }}" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col mb-3">
                                    <label for="deskripsi" class="form-label">Deskripsi Fasilitas</label>
                                    <textarea id="description" name="description" rows="4" class="form-control" cols="50">{{ isset($fasilitas->description) ? $fasilitas->description : '' }}
                                    </textarea>
                                </div>
                            </div>
                            <div class="row g-2">
                                ...
                                <div class="col mb-0">
                                    <div class="form-check mt-3">
                                        ...
                                        <input type="checkbox" value="1" class="form-check-input" id="scales"
                                            name="status"
                                            {{ isset($fasilitas->status) && $fasilitas->status == true ? 'checked' : '' }}>
                                ...
                                <div class="col mb-0">
                                    @if (isset($fasilitas->image))
                                        <img width="200px" id="blah"
                                            src="{{ '/upload/fasilitas/' . $fasilitas->image }}" alt="your image" />
                                    @else
